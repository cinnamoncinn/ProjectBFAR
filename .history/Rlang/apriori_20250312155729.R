...
rules <- apriori(df_trans, 
                 parameter = list(supp = 0.1, #0.1 to 0.2 is ideal for BIG dataset
                                  conf = 0.7,  #0.7 to 0.8 is ideal for BIG dataset
                                  minlen = 2, #0.7 to 0.8 is ideal for BIG dataset
                                  maxlen = 3)) #0.7 to 0.8 is ideal for BIG dataset 
