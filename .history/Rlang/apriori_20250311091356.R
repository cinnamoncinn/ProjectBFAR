...
# Load the dataset
file_path <- "dataset/cleaned_data.csv"  # Update with correct path
...
# Separate beneficiaries ("BENEFICIARY") and non-beneficiaries
beneficiaries <- df_selected[df_selected$`A2:GROUP` == "BENEFICIARY", -1]
non_beneficiaries <- df_selected[df_selected$`A2:GROUP` == "NON-BENEFICIARY", -1]
